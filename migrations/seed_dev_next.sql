...
--
-- Apply:  wrangler d1 execute brambletally --local --file=./migrations/seed_dev_next.sql
-- Remove: wrangler d1 execute brambletally --local --command "DELETE FROM project_steps WHERE id LIKE 'seed-%'; DELETE FROM project_collaborators WHERE project_id LIKE 'seed-%'; DELETE FROM projects WHERE id LIKE 'seed-%';"
--
