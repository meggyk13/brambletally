...
--   npx wrangler d1 execute brambletally --local --file=./migrations/0001_step_bash_estimate.sql
-- Apply (production):
--   npx wrangler d1 execute brambletally --remote --file=./migrations/0001_step_bash_estimate.sql
--
