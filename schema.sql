...
-- Shuffle tool state (migration 0015). Tracks when a "box" (an outstanding
-- gap on a project/step/inbox item, see worker/api/lib/shuffle.js) was last
-- drawn, skipped, or dismissed. No FK on the object half of box_key — loose
-- reference, same as reports.target_id.
